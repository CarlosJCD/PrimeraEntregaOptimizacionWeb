...
<body>
    <aside class="sidebar">
        ...
        <div class="sidebar__feeds">
            <h5 class="sidebar_titulo-feeds"> Feeds </h5>
            <div class="lista-feeds">
                <div class="feed">
                    ...
                    <p class="feed__nombre">Diario de Yucatán <span class="feed__cantidad-noticias">83</span> </p>
                </div> 
                <div class="feed">
                    <div class="feed__contenedor-imagen">
                        <img src="https://cdn-icons-png.flaticon.com/512/124/124033.png" alt="icono feed rss" width="12" height="12">
            ...
            <div class="sidebar__boton-editar">
                <div class="sidebar_boton-editar-php_logo">
